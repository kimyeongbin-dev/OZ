...
from fastapi import FastAPI, Path, Query, status, HTTPException, Body, Depends, BackgroundTasks
...
def send_email(name: str):
    import time
    time.sleep(3)   # 3초 대기
    print(f"{name}에게 이메일 전송이 완료되었습니다.", flush=True)
